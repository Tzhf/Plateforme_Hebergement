 ...
 */
final class Version20190204184548 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gestionnaire CHANGE ville_id ville_id INT DEFAULT NULL, CHANGE dispositif_id dispositif_id INT DEFAULT NULL, CHANGE roles roles JSON DEFAULT NULL COMMENT \'(DC2Type:json_array)\'');
        $this->addSql('ALTER TABLE location ADD created_at DATETIME NOT NULL, CHANGE date_entree date_entree DATE DEFAULT NULL, CHANGE date_sortie date_sortie DATE DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gestionnaire CHANGE ville_id ville_id INT DEFAULT NULL, CHANGE dispositif_id dispositif_id INT DEFAULT NULL, CHANGE roles roles JSON DEFAULT \'NULL\' COLLATE utf8mb4_bin COMMENT \'(DC2Type:json_array)\'');
        $this->addSql('ALTER TABLE location DROP created_at, CHANGE date_entree date_entree DATE DEFAULT \'NULL\', CHANGE date_sortie date_sortie DATE DEFAULT \'NULL\'');
