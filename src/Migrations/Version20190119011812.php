 ...
 */
final class Version20190119011812 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gestionnaire ADD roles JSON DEFAULT \'NULL\' COLLATE utf8mb4_bin COMMENT \'(DC2Type:json_array)\', DROP role, CHANGE ville_id ville_id INT DEFAULT NULL, CHANGE dispositif_id dispositif_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE location CHANGE date_entree date_entree DATE DEFAULT \'NULL\', CHANGE date_sortie date_sortie DATE DEFAULT \'NULL\'');
